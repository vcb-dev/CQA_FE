              ...
              <td>
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: "12px",
                      color: page.enabled ? "#16a34a" : "#6b7280",
                      fontWeight: 600,
                    }}
                  >
              ...
              <td style={{ textAlign: "right" }}>
                <button
                  onClick={() => {
                    if (
                      confirm(
                        `Bạn có chắc muốn xóa ${page.pageName || page.pageId} khỏi hệ thống?`,
                      )
                    ) {
...
export default function SettingsPage() {
  ...
  const defaultTabIdx =
    searchParams.get("tab") === "channel" && channelTabIdx !== -1
      ? channelTabIdx
      : 1;
...
Đầu ra định dạng JSON chứa điểm tổng quan, điểm từng tiêu chí, lý do chi tiết, ưu điểm và điểm cần cải thiện.`,
  ...
  const syncMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (isAsyncInboxSync(data)) {
        toast.info(
          data.message || "Đang đồng bộ nền — làm mới danh sách sau vài phút",
        );
        return;
      }
      toast.success(
        `Đồng bộ thành công ${data.synced} tin nhắn từ ${data.pageCount} trang!`,
      );
    },
    onError: (err) => {
      setIsSyncing(false);
  ...
  const refreshMutation = useMutation({
    ...
    onError: (err) => {
      setIsRefreshing(false);
      toast.error(
        "Lỗi khi đồng bộ lại danh sách trang: " + (err.message || err),
      );
    },
  });
  ...
  const fbPages = allChannelPages.filter(
  ...
  const tiktokConnectMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(
        `Đã kết nối ${data.pageCount} kênh TikTok từ Business Center.`,
      );
    },
    onError: (err) => {
  ...
  const handleWeightChange = (id, newWeight) => {
    setCriteria((prev) =>
      prev.map((c) =>
        c.id === id ? { ...c, weight: parseInt(newWeight) || 0 } : c,
      ),
    );
  };
  ...
  const currentCriteriaTotalWeight = criteria.reduce(
    (sum, c) => sum + (c.active ? c.weight : 0),
    0,
  );
      ...
      >
        {showSavedNotification && (
          ...
          >
            ...
            Đã cập nhật cấu hình hệ thống thành công! Tất cả các mô hình chấm
            điểm AI đang tự động học lại theo tiêu chí mới.
          </div>
        )}
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "11px", color: "#6b7280" }}>
                Quản lý hoạt động phân phối, múi giờ và tần suất sao lưu
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  defaultValue="VIENCHIBAO Chat Quality Agent Platform"
                />
              </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <option value="gmt8">
                      (GMT+08:00) Singapore, Manila, Beijing
                    </option>
                    <option value="gmt0">
              ...
              >
                ...
                >
                  ...
                  >
                    Tự động phân phối hội thoại (Smart Routing AI)
                  </span>
                  <span style={{ fontSize: "10.5px", color: "#6b7280" }}>
                    Tự động gán hội thoại mới từ QC cho nhân viên đang rảnh và
                    có tỷ lệ chốt sản phẩm đó cao nhất
                  </span>
                </label>
              </div>
              ...
              >
                ...
                >
                  ...
                  >
                    Thông báo cảnh báo tiêu cực tức thời
                  </span>
                  <span style={{ fontSize: "10.5px", color: "#6b7280" }}>
                    Gửi thông báo gấp về kênh Slack quản lý ngay khi AI phát
                    hiện hội thoại có cảm xúc &quot;Rất tiêu cực&quot;
                  </span>
                </label>
              </div>
            </div>
        ...
        {settingsTabs[activeTabIdx] === "AI & Chấm điểm" && (
          <>
            ...
            <div
              className="rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col animate-in fade-in slide-in-from-bottom-4"
              style={{ padding: "14px", animationDelay: "50ms" }}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                <div>
                  ...
                  >
                    Thiết lập Tiêu chí & Trọng số chấm điểm
                  </h3>
                  <p style={{ fontSize: "10.5px", color: "#6b7280" }}>
                    Chỉnh sửa hệ thống thang điểm đánh giá cuộc hội thoại của
                    Agent (Tổng trọng số phải bằng 100%)
                  </p>
                </div>
                ...
                <span
                  ...
                  style={{
                    background:
                      currentCriteriaTotalWeight === 100
                        ? "#f0fdf4"
                        : "#fef2f2",
                    color:
                      currentCriteriaTotalWeight === 100
                ...
                >
                  Tổng trọng số: {currentCriteriaTotalWeight}%{" "}
                  {currentCriteriaTotalWeight === 100 ? "✓" : "⚠️"}
                </span>
              </div>
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        value={c.weight}
                        onChange={(e) =>
                          handleWeightChange(c.id, e.target.value)
                        }
                        style={{
                          flex: 1,
                          height: "4px",
            ...
            >
              ...
              >
                ...
                >
                  Cấu hình Mô hình & AI System Prompts
                </h3>
                <p style={{ fontSize: "10.5px", color: "#6b7280" }}>
                  Tùy chọn LLM làm nhiệm vụ chấm điểm tự động và chỉnh sửa hướng
                  dẫn Prompt mẫu
                </p>
              </div>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Trí tuệ nhân tạo chấm điểm (LLM Audit Engine)
                  </div>
                  <div style={{ fontSize: "10.5px", color: "#3730a3" }}>
                    Lựa chọn model phù hợp nhất cho bài toán đánh giá ngữ cảnh
                    hội thoại phức tạp
                  </div>
                </div>
                <select
                ...
                >
                  <option value="gemini-1.5-pro">
                    Gemini 1.5 Pro (Khuyên dùng)
                  </option>
                  <option value="gemini-1.5-flash">
                    Gemini 1.5 Flash (Tốc độ cao)
                  </option>
                  <option value="claude-3.5-sonnet">
                    Claude 3.5 Sonnet (Đọc sâu)
                  </option>
                  ...
                  {prompts.map((p, idx) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (idx === 0)
                          setPromptContent(`Bạn là một chuyên gia đánh giá chất lượng chăm sóc khách hàng của thương hiệu trang sức VIENCHIBAO. Hãy phân tích đoạn hội thoại chat giữa Nhân viên tư vấn (Agent) và Khách hàng (Customer) để chấm điểm và rút ra nhận xét.
...
Đầu ra định dạng JSON chứa điểm tổng quan, điểm từng tiêu chí, lý do chi tiết, ưu điểm và điểm cần cải thiện.`);
                          ...
                          setPromptContent(`Hướng dẫn chấm điểm CSKH cho AI:
...
- Kiểm tra nhân viên có chủ động tư vấn ưu đãi/ship hay không.`);
                          ...
                          setPromptContent(`Prompt gợi ý trả lời tự động cho Agent:
...
- Luôn kết thúc bằng một câu hỏi gợi mở chốt đơn.`);
                      ...
                      style={{
                        ...
                        background:
                          selectedPromptIdx === idx ? "#e0e7ff" : "transparent",
                        color:
                          selectedPromptIdx === idx ? "#3730a3" : "#4b5563",
                        border:
                    ...
                    >
                      ...
                      >
                        <Lightbulb
                          size={12}
                          weight={
                            selectedPromptIdx === idx ? "fill" : "duotone"
                          }
                        />
                        <span>{p.name}</span>
                      </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Play size={10} weight="fill" /> Lưu và Thử nghiệm
                    </button>
                  </div>
                </div>
              </div>
            ...
            {isLoadingPages && !pagesData ? (
              ...
              <>
                ...
                >
                  ...
                  >
                    Cấu hình Kênh Kết nối
                  </h3>
                  <p style={{ fontSize: "11px", color: "#6b7280" }}>
                    Kết nối Meta (Facebook/Instagram) và TikTok for Business
                    riêng. Threads và YouTube chưa bật OAuth.
                  </p>
                </div>
                ...
                >
                  ...
                  <div
                    style={{
                      background: pagesData?.oauthConnected
                        ? "#f0fdf4"
                        : "#f9fafb",
                      border: pagesData?.oauthConnected
                        ? "1px solid #dcfce7"
                        : "1px solid #e5e7eb",
                      borderRadius: "8px",
                      padding: "16px",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <FacebookLogo
                          size={20}
                          weight={
                            pagesData?.oauthConnected ? "fill" : "regular"
                          }
                        />
                      </div>
                      <div>
                        ...
                        >
                          {pagesData?.oauthConnected
                            ? `Tài khoản Facebook: ${pagesData.oauthUser}`
                          ...
                          <>
                            ...
                            {pagesData.adsReadConnected &&
                              pagesData.adAccountCount != null && (
                                ...
                                >
                                  Đây là số{" "}
                                  <strong>tài khoản chi tiêu QC</strong> trên
                                  Ads Manager — <strong>không phải</strong> số
                                  Fanpage đang chạy quảng cáo. Nhiều Page có thể
                                  chạy QC qua chung một tài khoản; bạn đang quản
                                  lý <strong>{fbPages.length} Fanpage</strong>{" "}
                                  bên dưới.
                                </p>
                              )}
                          </>
                    ...
                    <button
                      onClick={() => {
                        window.location.href = getCskhOAuthStartUrl(
                          buildOAuthChannelReturnUrl(),
                        );
                      }}
                      style={{
                        padding: "8px 16px",
                  ...
                  {isOAuthSyncing && (
                    ...
                    >
                      ...
                      />
                      <span>
                        <strong>Đang đồng bộ Fanpage từ Facebook...</strong> Bạn
                        có thể dùng hệ thống ngay; danh sách Page sẽ cập nhật tự
                        động trong vài giây.
                      </span>
                    </div>
                  )}

                  {pagesData?.oauthSyncStatus === "failed" &&
                    pagesData?.oauthSyncError && (
                      <div
                        style={{
                          background: "#fef2f2",
                      ...
                      >
                        <strong>Đồng bộ Page thất bại:</strong>{" "}
                        {pagesData.oauthSyncError}
                      </div>
                    )}

                  {pagesData?.oauthConnected &&
                    pagesData.adsReadConnected === false && (
                      <div
                        style={{
                          background: "#fffbeb",
                      ...
                      >
                        <strong>Chưa kết nối Marketing API:</strong> Facebook
                        Page đã kết nối nhưng hệ thống không thấy tài khoản
                        quảng cáo. Bấm{" "}
                        <strong>Cập nhật kết nối Facebook</strong> và đăng nhập
                        bằng tài khoản <strong>admin tài khoản QC</strong> trên
                        Business Manager (không phải nút &quot;Đồng bộ lại
                        Pages&quot;).
                      </div>
                    )}
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <ChannelPagesTable
                      ...
                      busyText={
                        isRefreshing
                          ? "Đang đồng bộ lại danh sách trang..."
                      ...
                      onToggle={(pageId, enabled) =>
                        toggleMutation.mutate({ pageId, enabled })
                      }
                  ...
                  >
                    ...
                    >
                      Instagram Professional gắn vào Fanpage trên Meta. Sau đó
                      bấm <strong>Cập nhật kết nối Facebook</strong> để cấp
                      quyền tin nhắn.
                    </p>
                    <ChannelPagesTable
                      pages={igPages}
                  ...
                  >
                    ...
                    >
                      Scope <strong>TikTok Accounts</strong> — lấy kênh TikTok
                      Business đã gắn Business Center vào CRM. Chat (Business
                      Messaging) xin riêng sau khi list kênh xong.
                    </p>
                    <div
                      style={{
                        background: tiktokConnected ? "#f0fdf4" : "#f9fafb",
                        border: tiktokConnected
                          ? "1px solid #dcfce7"
                          : "1px solid #e5e7eb",
                        borderRadius: "8px",
                        padding: "14px",
                    ...
                    >
                      ...
                      >
                        ...
                        {tiktokConnected
                          ? "Cập nhật kết nối TikTok"
                          : "Kết nối TikTok for Business"}
                      </button>
                    </div>
                    <ChannelPagesTable
                      pages={ttPages}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: 11, color: "#6b7280", margin: 0 }}>
                        Toàn bộ page/kênh gắn với User Access Token Pancake
                        (Facebook, IG, TikTok…).
                      </p>
                    </div>
                  </div>
        ...
        {settingsTabs[activeTabIdx] === "Phân quyền" && (
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "11px", color: "#6b7280" }}>
                Quản lý vai trò truy cập nền tảng và gán quyền cho nhân viên
              </p>
            </div>
          ...
          settingsTabs[activeTabIdx] !== "Phân quyền" && (
            ...
            >
              ...
              <div>
                ...
                >
                  Hệ thống đang cấu hình các thông số mặc định tốt nhất cho
                  thương hiệu Viên Chi Bảo. Bạn có thể sử dụng ngay lập tức hoặc
                  nhấn nút kích hoạt để ghi đè.
                </p>
              </div>
              <button
                onClick={handleSaveSettings}
      ...
      >
        <div
          className="rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col animate-in fade-in slide-in-from-bottom-4"
          style={{ padding: "14px", animationDelay: "200ms" }}
        >
          <div
            style={{
              fontWeight: 700,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <CheckCircle size={10} weight="fill" /> Bật
              </span>
            </div>
          </div>
          <button
