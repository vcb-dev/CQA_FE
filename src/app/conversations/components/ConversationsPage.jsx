...
import InternalAIAssistant from "./InternalAIAssistant";
...
export const getTagStyle = (tag) => {
  ...
  if (
    t.includes("quan tâm sản phẩm") ||
    t.includes("khách quen") ||
    t.includes("điểm tốt") ||
    t.includes("tích cực") ||
    t.includes("hài lòng") ||
    t.includes("đã chốt đơn")
  ) {
  ...
  if (
    t.includes("chưa chốt đơn") ||
    t.includes("cần xử lý") ||
    t.includes("khiếu nại") ||
    t.includes("mặc cả") ||
    t.includes("tư vấn tệ") ||
...
export const buildSalesAssistant = (conv) => {
  const quote = getMarketQuote(conv);
  const primaryProduct =
    conv.interestedProducts?.[0] || "Sản phẩm khách đang hỏi";
  ...
  const products = [
    ...
    keywords.some(
      (k) =>
        k.toLowerCase().includes("quà") || k.toLowerCase().includes("gift"),
    )
      ? "Hộp quà premium + thiệp tặng kèm"
      : "Combo phụ kiện bạc 925 cùng kiểu",
  ]
    .filter(Boolean)
    .slice(0, 3);
  ...
  return {
    ...
    products: products.map((name, index) => ({
      ...
      signal:
        index === 0
          ? "Khách đã nhắc trực tiếp hoặc đang hỏi size/giá."
          : "Phù hợp để upsell nhẹ khi khách hỏi quà tặng, bảo hành hoặc muốn xem thêm mẫu.",
      pitch:
        index === 0
...
const mockTranslate = (text, flag) => {
  ...
  if (flag === "🇹🇭") {
    if (t.includes("chào") || t.includes("hello"))
      return "สวัสดีค่ะ ยินดีต้อนรับค่ะ";
    if (t.includes("giá") || t.includes("bao nhiêu"))
      return "ราคา 520 บาท พร้อมส่งวันนี้ค่ะ";
    if (t.includes("size") || t.includes("kích thước"))
      return "แหวนวงนี้มีไซส์พร้อมส่งค่ะ";
    if (t.includes("bảo hành")) return "รับประกันขัดเงาฟรีตลอดชีพค่ะ";
    return "ยินดีให้บริการค่ะ";
  }
  if (flag === "🇺🇸") {
    if (t.includes("chào") || t.includes("hello"))
      return "Hello! Welcome to Vienchibao Jewelry!";
    if (t.includes("giá") || t.includes("bao nhiêu"))
      return "It is currently $25 with free worldwide shipping today.";
    if (t.includes("size") || t.includes("kích thước"))
      return "Yes, we have all sizes from 5 to 10 in stock.";
    if (t.includes("bảo hành"))
      return "We offer a 12-month warranty and free lifetime polishing.";
    return "Thank you for your interest!";
  }
  if (flag === "🇯🇵") {
    if (t.includes("chào") || t.includes("hello"))
      return "こんにちは！お問い合わせありがとうございます。";
    if (t.includes("giá") || t.includes("bao nhiêu"))
      return "こちらは現在 3,800円でございます。";
    if (t.includes("size") || t.includes("kích thước"))
      return "日本サイズですと12号から18号までご用意がございます。";
    if (t.includes("bảo hành"))
      return "永久無料クリーニングと12ヶ月保証がございます。";
    return "どうぞよろしくお願いいたします。";
  }
  if (flag === "🇪🇸") {
    if (t.includes("chào") || t.includes("hello"))
      return "¡Hola! Bienvenido a la joyería Vienchibao.";
    if (t.includes("giá") || t.includes("bao nhiêu"))
      return "El precio es de 22 euros con envío gratuito hoy.";
    if (t.includes("size") || t.includes("kích thước"))
      return "Sí, tenemos tallas disponibles de la 12 a la 20.";
    if (t.includes("bảo hành"))
      return "Ofrecemos 12 meses de garantía y pulido gratuito de por vida.";
    return "Muchas gracias por su interés.";
  }
  if (flag === "🇮🇩") {
    if (t.includes("chào") || t.includes("hello"))
      return "Halo! Selamat datang di Toko Perak Vienchibao.";
    if (t.includes("giá") || t.includes("bao nhiêu"))
      return "Harganya Rp 350.000 dengan gratis ongkir hari ini.";
    if (t.includes("size") || t.includes("kích thước"))
      return "Ya, kami memiliki semua ukuran dari 14 hingga 22.";
    if (t.includes("bảo hành"))
      return "Garansi 12 bulan dan gratis pembersihan selamanya.";
...
const detailedConversations = [
  {
    ...
    campaign: "Thailand Brand Ads",
    adset: "Bangkok KM",
    cost: "14.500đ / Mess",
    firstMessage: "สนใจจะเอาวันนี้เลยค่ะ",
    ...
    aiSummary: {
      customerSaid: [
        "Quan tâm mẫu nhẫn bạc.",
        "Hỏi size có sẵn.",
        "Hỏi giá size 16.",
      ],
      goodPoints: [
        "Phản hồi nhanh",
        "Trả lời đầy đủ thông tin size và giá",
        "Tone giao tiếp lịch sự",
      ],
      badPoints: [
        "Chưa khai thác: mục đích mua, ngân sách, sở thích mẫu.",
        "Chưa tư vấn chất liệu, bảo hành, ưu điểm nổi bật.",
        "Chưa có upsell/đề xuất mẫu phù hợp.",
      ],
      suggestions: [
        'Hỏi thêm: "Anh/chị mua để làm gì ạ? (đeo hàng ngày, làm quà tặng...)"',
        "Tư vấn thêm chất liệu bạc, bảo hành làm sáng.",
        "Đề xuất thêm mẫu tương tự hoặc gợi ý kết hợp dây chuyền/lắc.",
      ],
    },
    customerKeywords: [
      "Nhẫn bạc Classic",
    ...
    internalNotes: [
      {
        ...
        time: "10:35 15/05/2026",
        text: "Nhân viên trả lời cộc lốc câu cuối cần được chấn chỉnh. Lần đầu nhắc nhở nhẹ.",
      },
    ],
    improvements: [
      "Chưa khai thác nhu cầu kỹ",
      "Chưa tư vấn điểm khác biệt sản phẩm",
    ],
    convInfo: {
      start: "15/05/2026 10:30",
      end: "15/05/2026 10:32",
      duration: "2 phút",
      msgCount: 6,
      status: "Chưa chốt đơn",
    },
    scoreHistory: [
      { date: "01/05", score: 50 },
      { date: "08/05", score: 72 },
    ...
    messages: [
      {
        id: 1,
        sender: "customer",
        text: "สนใจจะเอาวันนี้เลยค่ะ",
        translation: "Tôi quan tâm và muốn lấy mẫu này ngay hôm nay.",
        time: "10:30",
      },
      {
        id: 2,
        sender: "agent",
        text: "สวัสดีค่ะ แหวนรุ่นนี้มีไซส์ 12 ถึง 20 ค่ะ\n(Dạ chào anh/chị, nhẫn này có size từ 12 đến 20 ạ.)",
        time: "10:31",
        score: "good",
      },
      {
        id: 3,
        sender: "customer",
        text: "เอาไซส์ 16 ครับ",
        translation: "Cho tôi lấy size 16 nhé.",
        time: "10:31",
      },
      {
        id: 4,
        sender: "agent",
        text: "ได้เลยครับ! ไซส์ 16 ราคา 520 บาทครับ\n(Dạ vâng ạ, size 16 giá 520.000đ ạ.)",
        time: "10:32",
        score: "good",
      },
      {
        id: 5,
        sender: "customer",
        text: "มีของแถมไหมครับ",
        translation: "Có quà tặng kèm gì không shop?",
        time: "10:32",
      },
      {
        id: 6,
        sender: "agent",
        text: "ไม่มีของแถมครับ\n(Không có quà kèm đâu ạ.)",
        time: "10:33",
        score: "low",
      },
    ],
  },
  {
    ...
    flag: "🇻🇳",
    channel: "Facebook",
    preview: "Sản phẩm này còn size 17 không ạ?",
    time: "10:23",
    employee: "Phương Linh",
    score: 88,
    status: "reviewed",
    unread: 0,
    avatarColor: "#3b82f6",
    ...
    phone: "0987 654 321",
    isReturning: true,
    lastPurchase: "20/04/2026",
    source: "Tự nhiên (Organic)",
    campaign: "-",
    adset: "-",
    cost: "0đ (Organic)",
    firstMessage: "Sản phẩm này còn size 17 không ạ?",
    ...
    aiSummary: {
      customerSaid: [
        "Hỏi còn size 17 không",
        "Quan tâm nhẫn bạc classic",
        "Khách quen mua lần 4",
      ],
      goodPoints: [
        "Chào hỏi tốt, nhận ra khách quen",
        "Tư vấn kỹ size và chất liệu",
        "Upsell combo dây chuyền thành công",
      ],
      badPoints: ["Phản hồi hơi chậm (3 phút)"],
      suggestions: [
        "Gửi ảnh thật sản phẩm mới",
    ...
    internalNotes: [
      {
        id: 102,
        author: "Auditor Phương Linh",
        time: "10:25 15/05/2026",
        text: "Chăm sóc khách quen rất tốt, tặng quà đúng lúc. Phát huy thêm!",
      },
    ],
    improvements: ["Phản hồi khách hàng hơi chậm (trễ 3 phút)"],
    convInfo: {
      start: "15/05/2026 10:20",
      end: "15/05/2026 10:23",
      duration: "3 phút",
      msgCount: 6,
      status: "Đã chốt đơn",
    },
    ...
    messages: [
      {
        id: 1,
        sender: "customer",
        text: "Chào shop, mình muốn hỏi sản phẩm này còn size 17 không ạ?",
        time: "10:20",
      },
      {
        id: 2,
        sender: "agent",
        text: "Dạ chào anh Bảo! Cảm ơn anh đã quay lại shop ạ 😊 Nhẫn bạc Classic size 17 hiện vẫn còn hàng ạ.",
        time: "10:21",
        score: "good",
      },
      {
        id: 3,
        sender: "customer",
        text: "Tốt quá! Giá bao nhiêu vậy shop?",
        time: "10:21",
      },
      {
        id: 4,
        sender: "agent",
        text: "Dạ nhẫn bạc Classic size 17 giá 520.000đ ạ. Anh đã mua 3 lần bên em rồi, em xin tặng anh thêm hộp quà premium nhé ạ! 🎁",
        time: "10:22",
        score: "good",
      },
      {
        id: 5,
        sender: "customer",
        text: "Oke, mình lấy luôn nhé. Ship về địa chỉ cũ giúp mình.",
        time: "10:22",
      },
      {
        id: 6,
        sender: "agent",
        text: "Dạ em tạo đơn luôn cho anh ạ. Giao về 123 Nguyễn Huệ, Q1, HCM đúng không anh? Dự kiến 2-3 ngày ạ.",
        time: "10:23",
        score: "good",
      },
    ],
  },
  {
    ...
    flag: "🇺🇸",
    channel: "Instagram",
    preview: "Hi, I saw your Instagram ad...",
    time: "09:45",
    employee: "Hoàng Nam",
    score: 95,
    status: "reviewed",
    ...
    campaign: "USA Campaign 05",
    adset: "US Female Group",
    cost: "1.2$ / Mess",
    firstMessage: "Hi, I saw your Instagram ad...",
    ...
    aiSummary: {
      customerSaid: [
        "Hỏi về ship hàng đi Singapore",
        "Hỏi thời gian giao hàng",
        "Muốn mua nhẫn bạc size 6",
      ],
      goodPoints: [
        "Phản hồi bằng tiếng Anh chuẩn xác",
        "Tư vấn rõ ràng về phí và thời gian ship",
        "Chốt đơn nhanh và chuyên nghiệp",
      ],
      badPoints: [],
      suggestions: [
        "Gửi mã tracking đơn hàng ngay khi gửi bưu điện",
        "Đề xuất combo để được free ship quốc tế",
      ],
    },
    customerKeywords: [
      "Singapore shipping",
    ...
    internalNotes: [
      {
        id: 103,
        author: "Auditor Hoàng Nam",
        time: "09:50 15/05/2026",
        text: "English chat support is exceptional. Fast chốt đơn.",
      },
    ],
    improvements: [],
    convInfo: {
      start: "15/05/2026 09:40",
      end: "15/05/2026 09:45",
      duration: "5 phút",
      msgCount: 6,
    ...
    messages: [
      {
        id: 1,
        sender: "customer",
        text: "Hi, I saw your Instagram ad. Do you ship to Singapore?",
        translation:
          "Xin chào, tôi thấy quảng cáo Instagram của shop. Shop có ship đi Singapore không?",
        time: "09:40",
      },
      {
        id: 2,
        sender: "agent",
        text: "Hello Sarah! Yes, we do provide international shipping to Singapore! ✈️ Shipping fee is around $10.\n(Chào chị Sarah! Dạ bên em có ship đi Singapore ạ, phí ship là $10.)",
        time: "09:41",
        score: "good",
      },
      {
        ...
        translation: "Tuyệt quá! Giao hàng thường mất bao lâu?",
        time: "09:42",
      },
      {
        id: 4,
        sender: "agent",
        text: "It typically takes 5-7 business days. We will provide a tracking number as soon as it is shipped out.\n(Dạ thường mất 5-7 ngày làm việc ạ. Em sẽ gửi mã tracking ngay sau khi gửi đi.)",
        time: "09:43",
        score: "good",
      },
      {
        id: 5,
        sender: "customer",
        text: "Perfect, I'd like to order the classic silver ring in size 6.",
        translation: "Tuyệt, tôi muốn đặt nhẫn bạc classic size 6.",
        time: "09:44",
      },
      {
        id: 6,
        sender: "agent",
        text: "Excellent choice! I've reserved a size 6 for you. Let me send you the payment link to finalize your order.\n(Lựa chọn tuyệt vời ạ! Em đã giữ 1 nhẫn size 6 cho chị. Em gửi link thanh toán nhé.)",
        time: "09:45",
        score: "good",
      },
    ],
  },
  {
    ...
    aiSummary: {
      customerSaid: [
        "Hỏi tư vấn chọn size nhẫn cho chu vi ngón tay 52mm",
        "Gặp khó khăn trong việc tự đo size",
      ],
      goodPoints: ["Phản hồi bằng tiếng Nhật đúng ngữ pháp cơ bản"],
      badPoints: [
        "Thái độ phục vụ thiếu nhiệt tình, trả lời cộc lốc",
        "Bảo khách tự đo và tự lên mạng tìm kiếm thay vì hướng dẫn chi tiết",
        "Gây ức chế cho khách hàng Nhật vốn quen với sự chu đáo",
      ],
      suggestions: [
        "Yêu cầu nhân viên học lại quy trình tư vấn khách nước ngoài",
        "Cung cấp bảng size nhẫn tiêu chuẩn Nhật Bản và Việt Nam",
        'Sử dụng các mẫu câu lịch sự Keigo: "少々お待ちくださいませ..."',
      ],
    },
    customerKeywords: [
      "Ring size 52mm",
    ...
    internalNotes: [
      {
        id: 104,
        author: "Auditor Thành Đạt",
        time: "09:15 15/05/2026",
        text: "Thái độ phục vụ tệ hại. Đã chuyển quản lý team xử lý kỷ luật.",
      },
    ],
    improvements: [
      "Thái độ phục vụ thiếu nhiệt tình, cộc lốc",
      "Yêu cầu khách tự lên mạng tra thay vì hướng dẫn",
    ],
    convInfo: {
      start: "15/05/2026 09:05",
      end: "15/05/2026 09:12",
      duration: "2 phút",
      msgCount: 6,
      status: "Chưa chốt đơn",
    },
    ...
    messages: [
      {
        id: 1,
        sender: "customer",
        text: "こんにちは、このシルバーリングのサイズについて聞きたいのですが。",
        translation: "Xin chào, tôi muốn hỏi về size của chiếc nhẫn bạc này.",
        time: "09:05",
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        sender: "customer",
        text: "指の周りが52mmの場合、どのサイズが良いですか？",
        translation: "Nếu chu vi ngón tay là 52mm thì đeo size nào tốt?",
        time: "09:08",
      },
      {
        id: 4,
      ...
      },
      {
        id: 5,
        sender: "customer",
        text: "えっ？測り方がわからないのですが...",
        translation: "Ơ? Tôi không biết cách đo...",
        time: "09:10",
      },
      {
        id: 6,
        sender: "agent",
        text: "ネットで調べてください。\n(Chị lên mạng tìm nhé.)",
        time: "09:12",
        score: "low",
      },
    ],
...
const generatedConversations = Array.from({ length: 46 }, (_, idx) => {
  ...
  const label =
    score >= 85 ? "Tốt" : score >= 70 ? "Trung bình" : "Cần cải thiện";
  ...
  const agentTexts = {
    "🇹🇭":
      score >= 85
        ? "สวัสดีค่ะ มีไซส์ 15 พร้อมส่งค่ะ! 💍\nDạ chào chị, nhẫn size 15 bên em có sẵn hàng ạ."
        : "ไม่มีค่ะ\nKhông có chị nha.",
    "🇺🇸":
      score >= 85
        ? "Hello! Yes, it is fully in stock and ready to ship today! ✈️\nDạ chào anh/chị, hàng sẵn có và có thể gửi ngay hôm nay ạ."
        : "Please wait, checking.\nVui lòng chờ chút để em kiểm tra.",
    "🇯🇵":
      score >= 85
        ? "お問い合わせありがとうございます！日本へはEMS郵便で追跡可能でお届けします。🇯🇵\nDạ bên em ship qua bưu điện quốc tế EMS có tracking đầy đủ ạ."
        : "No ship Japan.\nBên em không ship Nhật đâu.",
    "🇪🇸":
      score >= 85
        ? "¡Hola! El envío a Barcelona cuesta 12 euros y tarda unos 7 días hábiles. 😊\nDạ ship Barcelona là 12 euro và mất khoảng 7 ngày ạ."
        : "Very expensive.\nPhí ship đắt lắm chị ơi.",
    "🇮🇩":
      score >= 85
        ? "Halo! Bisa banget kak, free grafir nama di bagian dalam cincin ya kak. ❤️\nDạ được chứ ạ, khắc tên hoàn toàn miễn phí mặt trong nhẫn ạ."
        : "Tidak bisa.\nKhông khắc được đâu.",
    "🇻🇳":
      score >= 85
        ? "Dạ mẫu nhẫn bạc Classic đính đá CZ này giá là 520.000đ và đang được ưu đãi miễn phí giao hàng toàn quốc hôm nay ạ! 🥰"
        : "Nhìn giá trên hình đi ạ.",
  };
  ...
  const messages = [
    {
      id: 1,
      sender: "customer",
      text: customerTexts[flag],
      translation: "Tôi rất quan tâm mẫu nhẫn/lắc bạc mới bên bạn.",
      time: "08:00",
    },
    {
      id: 2,
      sender: "agent",
      text: agentTexts[flag],
      time: "08:02",
      score: score >= 85 ? "good" : score >= 70 ? "medium" : "low",
    },
  ];
  ...
  const interestedProducts =
    flag === "🇻🇳" ? ["Nhẫn bạc Classic đính đá"] : ["Nhẫn bạc 925 Global"];
      ...
      ? [
          {
            id: 300 + idx,
            author: "AI Audit Bot",
            time: "08:15 15/05/2026",
            text: "Thời gian phản hồi trễ quá quy định (SLA > 5p). Cần chấn chỉnh.",
          },
        ]
      : [];
  ...
  return {
    ...
    avatarColor:
      idx % 3 === 0 ? "#ec4899" : idx % 3 === 1 ? "#10b981" : "#6366f1",
    isAds,
    page,
    ...
    tags: [
      isAds ? "Quảng cáo" : "Tự nhiên",
      score >= 85 ? "Có tín hiệu chốt" : "Cần tư vấn thêm",
    ],
    ...
    aiSummary: {
      customerSaid: [
        "Quan tâm mẫu nhẫn/lắc tay mới.",
        "Hỏi ship có sẵn.",
        "Hỏi giá ưu đãi.",
      ],
      goodPoints:
        score >= 70
          ? ["Phản hồi nhanh", "Tone giao tiếp lịch sự"]
          : ["Có phản hồi nhanh"],
      badPoints:
        score < 85
          ? [
              "Chưa khai thác: mục đích mua, ngân sách.",
              "Chưa tư vấn chất liệu, bảo hành.",
            ]
          : [],
      suggestions:
        score < 85
          ? [
              'Hỏi thêm: "Anh/chị mua dùng hay làm quà tặng?"',
              "Tư vấn thêm chất liệu bạc, đánh bóng.",
            ]
          : ["Tiếp tục duy trì kỹ năng chăm sóc tốt"],
    },
    customerKeywords,
    interestedProducts,
    suggestedReplies,
...
const getMarketQuote = (conv) => {
  const quotes = {
    "🇹🇭": {
      price: "520 baht",
      localPrice: "khoảng 520.000đ",
      shipping: "miễn phí ship nội địa hôm nay",
    },
    "🇺🇸": {
      price: "$25",
      localPrice: "khoảng 620.000đ",
      shipping: "ship quốc tế có tracking",
    },
    "🇯🇵": {
      price: "3.800 yen",
      localPrice: "khoảng 620.000đ",
      shipping: "EMS có tracking",
    },
    "🇪🇸": {
      price: "22 euro",
      localPrice: "khoảng 590.000đ",
      shipping: "ship quốc tế 7-10 ngày",
    },
    "🇮🇩": {
      price: "Rp 350.000",
      localPrice: "khoảng 560.000đ",
      shipping: "miễn phí ship trong ngày",
    },
    "🇻🇳": {
      price: "520.000đ",
      localPrice: "520.000đ",
      shipping: "miễn phí giao hàng toàn quốc hôm nay",
    },
  };
...
const getSentimentInsight = (sentiment = {}) => {
  ...
  if (negative >= 45) {
    return {
      ...
      bg: "var(--danger-50)",
      explanation:
        "Ưu tiên xin lỗi, hướng dẫn cụ thể và tránh trả lời ngắn. Nên xử lý vấn đề trước khi chốt đơn.",
    };
  }
  ...
  if (positive >= 75) {
    return {
      ...
      bg: "var(--success-50)",
      explanation:
        "Khách phản hồi tích cực, có thể báo giá rõ ràng, nhắc ưu đãi và xin thông tin chốt đơn.",
    };
  }
  ...
  return {
    ...
    bg: "var(--warning-50)",
    explanation:
      "Khách còn đang cân nhắc. Nên hỏi thêm nhu cầu, size, mục đích mua và đưa 1-2 lựa chọn phù hợp.",
  };
};
...
const findKnowledgeProducts = (question, conv) => {
  ...
  const context =
    `${conv.interestedProducts?.join(" ") || ""} ${conv.customerKeywords?.join(" ") || ""}`.toLowerCase();
  const haystack = `${q} ${context}`;
  const matches = internalProducts.filter((product) => {
    const productText =
      `${product.name} ${product.sku} ${product.variants} ${product.note}`.toLowerCase();
    return productText
      .split(/\s+/)
...
const answerInternalAI = (question, conv) => {
  ...
  const asksStock = ["tồn", "kho", "còn", "con", "stock", "size"].some((k) =>
    q.includes(k),
  );
  const asksPrice = ["giá", "gia", "price", "báo giá", "bao nhiêu"].some((k) =>
    q.includes(k),
  );
  const asksModel = [
    "mẫu",
  ...
  const productLines = products
    .map((product) => {
      ...
      if (asksPrice || (!asksStock && !asksModel))
        lines.push(`Giá: ${product.price}; quy đổi: ${product.altPrices}`);
    ...
    <div className="chat-panel" style={{ height: "100%" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          {conv.flag !== "🇻🇳" && (
            ...
            >
              <Translate
                size={14}
                style={{ color: showTranslation ? "#2563eb" : "var(--n-500)" }}
              />
                ...
                {!isAgent && showTranslation && msg.translation && (
                  <div
                    style={{
                      marginTop: "4px",
                      paddingTop: "4px",
                      borderTop: "1px dashed var(--n-200)",
                      fontSize: "11.5px",
                      color: "#166534",
                      fontWeight: 600,
                      display: "flex",
      ...
      >
        ...
        >
          ...
          {["Hỏi giá", "Báo giá", "Tạo đơn", "Chờ chuyển"].map(
            (quickTag, idx) => {
              const isTagAdded =
                conv.customTags.includes(quickTag) ||
                conv.tags.includes(quickTag);
                ...
                <button
                  ...
                  onClick={() => {
                    if (isTagAdded) {
                      onUpdateTags(
                        conv.id,
                        conv.customTags.filter((t) => t !== quickTag),
                      );
                    } else {
        ...
        {/* Input area Tab bar */}
        <div
          className="chat-input-tabs"
          style={{ marginBottom: "8px", display: "flex", gap: "2px" }}
        >
          {[
            ...
            <button
              key={t.id}
              className={`chat-input-tab ${inputTab === t.id ? "active" : ""}`}
        ...
        <div style={{ position: "relative", marginBottom: "8px" }}>
          ...
          {autoTranslate && conv.flag !== "🇻🇳" && inputText.trim() && (
            ...
            >
              ...
              <span>
                Bản dịch AI gửi đi: "
                {mockTranslate(inputText.trim(), conv.flag)}"
              </span>
            </div>
          )}
        </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            >
              {[Smiley, FileText, Image, Paperclip, Microphone, QrCode].map(
                (Icon, i) => (
                  <button key={i} className="chat-input-icon">
                    <Icon />
                  </button>
                ),
              )}
...
// ─────────────────────────────────────────
// (RightPanel component removed, now imported from ./RightPanel)
...
export default function ConversationsPage() {
  ...
  const filteredConversations = convData.filter((c) => {
    ...
    if (selectedPages.length > 0 && !selectedPages.includes(c.page))
      return false;
    ...
    if (
      ...
      !c.customTags.includes(tagFilter)
    )
      return false;
    // 4. Search Filter
    if (search.trim()) {
  ...
  const selectedConv =
    convData.find((c) => c.id === activeConv) ||
    filteredConversations[0] ||
    convData[0];

  const handleUpdateTags = (convId, newTags) => {
    setConvData((prev) =>
      prev.map((c) => (c.id === convId ? { ...c, customTags: newTags } : c)),
    );
  };
  ...
  const handleSendMessage = (convId, text) => {
    ...
    setDraftReplies((prev) => ({ ...prev, [convId]: null }));
  };
  ...
  const handleTriggerAction = (actionId, label) => {
    const addCustomTag = (tag) => {
      handleUpdateTags(
        selectedConv.id,
        Array.from(new Set([...selectedConv.customTags, tag])),
      );
    };
    ...
    if (actionId === "create_order" || actionId === "place_order") {
      ...
      triggerToast(
        `Đã lên đơn hàng thành công cho khách hàng ${selectedConv.name}!`,
      );
      ...
      triggerToast(
        `Đã chuyển hội thoại sang nhân viên khác chăm sóc thành công.`,
      );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "11px", color: "var(--n-400)" }}>
              AI-Powered Smart Omni-channel Inbox
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                {selectedPages.length === ALL_PAGES.length ? (
                  ...
                  <span>
                    {ALL_PAGES.find((p) => p.name === selectedPages[0])?.flag}{" "}
                    {selectedPages[0]}
                  </span>
                ) : (
              ...
              <CaretDown
                ...
                style={{
                  color: "var(--n-500)",
                  transform: showPageDropdown ? "rotate(180deg)" : "none",
            ...
            {showPageDropdown && (
              ...
              >
                ...
                >
                  <button
                    onClick={() =>
                      setSelectedPages(ALL_PAGES.map((p) => p.name))
                    }
                    style={{
                      flex: 1,
                      padding: "4px 6px",
                          ...
                          onChange={() => {
                            if (isChecked) {
                              setSelectedPages((prev) =>
                                prev.filter((name) => name !== page.name),
                              );
                            } else {
      ...
      <div style={{ display: "flex", gap: "10px", flex: 1, minHeight: 0 }}>
        ...
        >
          <ChatPanelComponent
            ...
            draftReply={draftReplies[selectedConv.id]}
          />
        </div>
